					...
					<div className='article'>
						...
						<div className='article-text'>
							...
							<p className='article-paragraph'>
								...
								cumque! Dicta reprehenderit facere ipsum unde molestias repellat quaerat non rem, voluptatem consequatur
								temporibus doloribus voluptate deleniti laborum voluptas!
							</p>
						</div>
					</div>
