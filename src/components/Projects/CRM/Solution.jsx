	...
	return (
		<section className="solution-wrapper_crm">
			...
			<p className="solution-note">
				*It's worth noting that in order to respect the company's idea as as well as their privacy policy not all of the
				details can be shared.
			</p>
			<div className="solution-grid">
				{GRID_ARTICLES.map(({ id, title, text }) => {
					return (
						<article className={`grid-article article-${id}`}>
